...
class RecommendationEngine:
    ...
    def recommend(self, game_name, num_recommendations=9, min_reviews=5000, min_rating=0.65):
        """
        Enhanced recommendation with quality filters
        
        Args:
            game_name: Name of the game
            num_recommendations: Number of games to recommend
            min_reviews: Minimum number of total reviews
            min_rating: Minimum positive review ratio
        """
